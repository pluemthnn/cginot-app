...
class WritePost extends StatefulWidget {
  ...
  WritePost({required this.userData});
  @override
...
class _WritePost extends State<WritePost> {
  ...
  void _postToFB() async {
    ...
    var utilsFunction = Utils();

    String postID =
        utilsFunction.getRandomString(8) + Random().nextInt(500).toString();
    String postImageURL;
    ...
    //     widget.userData, postImageURL ?? 'NONE');
                            ...
                            children: <Widget>[
                              Padding(
                                ...
                                child: Container(
                                    ...
                                    height: 40,
                                    child: Image.asset(
                                        'images/${widget.userData.Thumbnail}')),
                              ),
                              Text(
